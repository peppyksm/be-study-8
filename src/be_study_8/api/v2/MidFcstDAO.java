...
import be_study_8.db.v4.StudentDTO;

public class MidFcstDAO {

	/*
	 * CREATE TABLE MID_TA ( --no tm_fc VARCHAR2(16), reg_id VARCHAR2(8), ta_min4
	 * NUMBER, ta_max4 NUMBER, ta_min5 NUMBER, ta_max5 NUMBER, CONSTRAINT MID_TA_PK
	 * PRIMARY KEY (tm_fc, reg_id) );
	 * 
	 * CREATE TABLE MID_TA_REG_ID ( reg_id VARCHAR2(8), reg_name VARCHAR2(32) );
	 */
